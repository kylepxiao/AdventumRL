...
parser.add_argument("--mission_file", help='choose which mission file to run', default='./rabbit_stew.xml') # Change back to true defaults later! 
parser.add_argument("--quest_file", help='choose file to specify quest entities', default='./rabbit_entities.xml')
parser.add_argument("--grammar_file", help='choose file to specify logical grammar', default="./rabbit_grammar.json")
